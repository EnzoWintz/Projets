Ce projet se base sur un projet déjà existant mais ou nous avions comme consigne de l'adapter afin qu'il soit déployé au sein d'un environnement Gitlab,
