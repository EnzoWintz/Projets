...
#export MYSQL2_HOME_BASE_SSH=$(curl -H "X-Vault-Token: $VAULT_TOKEN" -X GET http://172.25.0.10:8200/v1/secret/data/MYSQL2_HOME_BASE_SSH | jq '.data.data.MYSQL2_HOME_BASE_SSH' | tr -d \")
